...
namespace UnityEditor
{
    ...
    {
        enum PipelineType { Unsupported, BuiltInPipeline, UniversalPipeline, HDPipeline }

        static RenderingPipelineDefines() { UpdateDefines(); }
        ...
        static void UpdateDefines() {
            ...
            if (pipeline == PipelineType.UniversalPipeline) { AddDefine("UNITY_PIPELINE_URP"); }
            else { RemoveDefine("UNITY_PIPELINE_URP"); }

            if (pipeline == PipelineType.HDPipeline) { AddDefine("UNITY_PIPELINE_HDRP"); }
            else { RemoveDefine("UNITY_PIPELINE_HDRP"); }
        }
        ...
        static PipelineType GetPipeline() {
            ...
            if (GraphicsSettings.renderPipelineAsset != null) {
                ...
                if (srpType.Contains("HDRenderPipelineAsset")) { return PipelineType.HDPipeline; }
                    ...
                    || srpType.Contains("LightweightRenderPipelineAsset")) { return PipelineType.UniversalPipeline; }
                else
